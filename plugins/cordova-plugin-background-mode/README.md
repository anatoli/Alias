...
This is a folk version of cordova-plugin-background-mode plugin | 
-Removed the IOS background audio plist declaration
-Fix the android bg service init/destroy issue
...
Execute from the projects root folder:
    ...
    $ cordova plugin add cordova-plugin-background-mode-alwaysmkt
