...
export * from './api';
export { WebViewAd, AppOpenAd, BannerAd, BannerAdOptions, InterstitialAd, NativeAd, NativeAdOptions, RewardedAd, RewardedAdOptions, RewardedInterstitialAd, RewardedInterstitialAdOptions, ServerSideVerificationOptions, };
export declare class AdMob {
    readonly WebViewAd: typeof WebViewAd;
